...
```
  ...
  - *** For the full dataset extraction, go to the full code in: ```src/ETL_ukb.ipynb``` in this codebase ([link](https://github.com/zhaohanxiong/OxfordCVM/blob/dev/src/ETL_ukb.ipynb))
