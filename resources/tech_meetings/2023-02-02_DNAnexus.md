...
# define all columns we are interested in (just a few for example)
field_ids = [31, 4079, 4080, 6150]
...
```
  ...
  - *** For the full dataset extraction, go to the full code in: ```src/ETL_ukb.ipynb``` in this codebase ([link](https://github.com/zhaohanxiong/OxfordCVM/blob/7241bc09f7474368226470034aff722f00323d52/src/ETL_ukb.ipynb))
