...
9) Notes
    ...
    - I currently have not found where the IDPs (imaging derived phenotypes, or the big spreadsheet of all the numerical values) are located, so for now, the data here is only for the meta data and bulk data
