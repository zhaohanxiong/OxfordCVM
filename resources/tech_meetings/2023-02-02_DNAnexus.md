...
# create pyspark session (only run this once)
...
```
  - once this code is ran, you can see the new file output in the "folder" symbol on the left hand side tab at the very top
  - you can right click, download to download it straight onto your desktop
  - you can also invoke a terminal command similar to R above, and save it to your project (for others to potentially use)
  - use the "+" button along the top to add a new cell block and copy the code below
  - copy/paste the output from above for the filename and paste in the <> part below to invoke bash command 
```
%%bash
dx upload <copy name printed above> --dest /
```
  - If you navigate back to your "project" tab on your main UKB RAP homepage and go into your project, you can see this new .csv file there
  - Now you can download it normally
