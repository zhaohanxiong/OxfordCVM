classdef ReshapeLayer1D < nnet.layer.Layer & ...
         nnet.layer.Formattable
    % Example reshape layer.

    methods
        function layer = ReshapeLayer1D(NameValueArgs)
            ...
            layer.Description = "Reshape 1D layer";
            
            % Set layer type.
            layer.Type = "Reshape 1D";
        ...
        function Z = predict(~, X)
            ...
            % Reshape as image
            inputSize = size(X);
            Z = reshape(X, inputSize(3), inputSize(4), []);
