function [stats_hs,stats_hs_sex,stats_female,stats_male] = extract_survival_hs(ukb_outcomes,sex,selected_group,global_pseudotimes,events,events_ids,age_events,sex_analysis,tag)

stats_hs_sex = single.empty;
