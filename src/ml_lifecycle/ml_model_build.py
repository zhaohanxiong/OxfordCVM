...
pseudotimes = pd.read_csv("../modelling/NeuroPM/io/pseudotimes.csv", index_col = False)
...
ukb_num = pd.read_csv("../modelling/NeuroPM/io/ukb_num_norm_ft_select.csv", index_col = False).fillna(0).to_numpy()
pc_transform = scipy.io.loadmat("../modelling/NeuroPM/io/PC_Transform.mat")["Node_Weights"]
...
model.save("mlflow/mlruns_staging/")
